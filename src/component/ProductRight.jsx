import { Row,Col,Form, Button,Tabs,Tab,Pagination, Container,Card} from 'react-bootstrap'
                          ...
                          <div className="ProductImg">
                              ...
                              <div className="slider-container">
                                  ...
                                  <div className="border">
                                      <img src={style11} alt="productImg" width={'450px'} height={'530px'} style={{objectFit:'cover',position:'center'}}/>
                                    </div>
                                    <div>
                                      <img src={style13} alt="productImg" width={'450px'} height={'530px'}  style={{objectFit:'cover',position:'center'}}
                                      className='border position-relative rounded'/>
                                    </div>
                                    <div className="imgBox">
                                      <img src={style12} alt="productImg" width={'450px'} height={'530px'}  style={{objectFit:'cover',position:'center'}}/>
                                    </div>
                                    <div className="imgBox">
                                    <img src={style1} alt="productImg" width={'450px'} height={'530px'}  style={{objectFit:'cover',position:'center'}}/>
                                    </div>
                                    <div className="imgBox">
                                      <img src={style4} alt="productImg" width={'450px'} height={'530px'}  style={{objectFit:'cover',position:'center'}}/>
                                    </div>
                                    <div className="imgBox">
                                      <img src={style14} alt="productImg" width={'450px'} height={'530px'}  style={{objectFit:'cover',position:'center'}}/>
                                    </div>
                                    <div className="imgBox">
                                    <img src={style15} alt="productImg" width={'450px'} height={'530px'}  style={{objectFit:'cover',position:'center'}}/>
                                    </div>
                                    <div className="imgBox">
                                      <img src={style16} alt="productImg" width={'450px'} height={'530px'}  style={{objectFit:'cover',position:'center'}}/>
                                    </div>
                                  </Slider>
                                  <Slider
                                    asNavFor={nav1}
